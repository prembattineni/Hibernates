...
public class HQLDemo1 {
	...
	for(Product p:list)
	{
	 ...
	 System.out.println("------------------------");
	 System.out.println("Select query with conditions with where clause and user input");
	 Query<Product> query3=session.createQuery("select prd from Product prd where prd.price> :pric ");
	 System.out.println("enetr the price");
	 Scanner sc=new Scanner(System.in);
	 int price=sc.nextInt();
	 query3.setParameter("pric", price);
	 List<Product> products2=query3.list();
